...
class IGContactformHelper {
	...
	public static function apply_assets( $assets ) {
		$version = defined( 'IG_CONTACTFORM_VERSION' ) ? IG_CONTACTFORM_VERSION : '1.0.0';
		
		/**
		 * Bootstrap 2
		 */
		$assets[ 'ig-bootstrap2-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/bs2/bootstrap/css/bootstrap.min.css',
			'ver' => $version,
		);
		$assets[ 'ig-bootstrap2-responsive-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/bs2/bootstrap/css/bootstrap-responsive.min.css',
			'ver' => $version,
		);
		$assets[ 'ig-bootstrap2-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/bs2/bootstrap/js/bootstrap.min.js',
			'ver' => $version,
		);
		$assets[ 'ig-bootstrap2-icomoon-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/bs2/font-icomoon/css/icomoon.css',
			'ver' => $version,
		);
		$assets[ 'ig-bootstrap2-jsn-gui-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/bs2/jsn/css/jsn-gui.css',
			'ver' => $version,
		);
		
		$assets[ 'ig-jquery-json-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-json/json-2.3.min.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-tipsy-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-tipsy/jquery.tipsy.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-tmpl-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-tmpl/jquery.tmpl.js',
			'ver' => $version,
		);

		$assets[ 'ig-jquery-placeholder-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-placeholder/jquery.placeholder.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-select2-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/select2/select2.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-scrollto-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-scrollto/jquery.scrollTo.js',
			'ver' => $version,
		);

		$assets[ 'ig-jquery-colorpicker-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/colorpicker/js/colorpicker.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-wysiwyg-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-jwysiwyg/jquery.wysiwyg.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-wysiwyg-colorpicker-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-jwysiwyg/controls/wysiwyg.colorpicker.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-wysiwyg-table-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-jwysiwyg/controls/wysiwyg.table.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-wysiwyg-cssWrap-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-jwysiwyg/controls/wysiwyg.cssWrap.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-wysiwyg-image-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-jwysiwyg/controls/wysiwyg.image.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-wysiwyg-link-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-jwysiwyg/controls/wysiwyg.link.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-wysiwyg-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-jwysiwyg/jquery.wysiwyg.css',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-codemirror-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/codemirror/lib/codemirror.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-codemirror-matchbrackets-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/codemirror/addon/edit/matchbrackets.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-codemirror-mode-css-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/codemirror/mode/css/css.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-codemirror-markselection-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/codemirror/addon/selection/mark-selection.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-codemirror-activeline-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/codemirror/addon/selection/active-line.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-codemirror-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/codemirror/lib/codemirror.css',
			'ver' => $version,
		);
		$assets[ 'ig-zero-clipboard-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/zeroclipboard/ZeroClipboard.js',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-jquery-layout-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/js/layout.js',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/js/contactform.js',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-visualdesign-js' ] = array(
			'src' => get_admin_url() . '/?ig-gadget=contactform-js-visualdesign-core&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-itemlist-js' ] = array(
			'src' => get_admin_url() . '?ig-gadget=contactform-js-visualdesign-itemlist&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-emailsettings-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/js/emailsettings.js',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-controls-js' ] = array(
			'src' => get_admin_url() . '/?ig-gadget=contactform-js-visualdesign-controls&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-form-js' ] = array(
			'src' => get_admin_url() . '/?ig-gadget=contactform-js-form&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-forms-js' ] = array(
			'src' => get_admin_url() . '/?ig-gadget=contactform-js-forms&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-modal-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/js/modal.js',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-editor-plugin-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/js/editor_plugin.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-tipsy-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-tipsy/tipsy.css',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-colorpicker-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/colorpicker/css/colorpicker.css',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/css/contactform.css',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-editor-plugin-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/css/editor_plugin.css',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-select2-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/select2/select2.css',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-ui-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/jquery-ui/css/ui-bootstrap/jquery-ui-1.9.0.custom.css',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-submissions-js' ] = array(
			'src' => get_admin_url() . '/?ig-gadget=contactform-js-submissions&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-contactform-submission-js' ] = array(
			'src' => get_admin_url() . '/?ig-gadget=contactform-js-submission&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-daterangepicker-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/daterangepicker/daterangepicker.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-daterangepicker-moment-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/daterangepicker/moment.js',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-daterangepicker-bs2-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/daterangepicker/daterangepicker-bs2.css',
			'ver' => $version,
		);
		$assets[ 'ig-jquery-daterangepicker-bs3-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'assets/3rd-party/daterangepicker/daterangepicker-bs3.css',
			'ver' => $version,
		);
		//frontend
		$assets[ 'ig-frontend-contactform-css' ] = array(
			'src' => IG_CONTACTFORM_URI . 'frontend/css/form.css',
			'ver' => $version,
		);
		$assets[ 'ig-frontend-contactform-js' ] = array(
			'src' => get_site_url() . '/?ig-gadget=contactform-js-form-frontend&action=default',
			'ver' => $version,
		);
		$assets[ 'ig-frontend-contactform-bootstrap-js' ] = array(
			'src' => IG_CONTACTFORM_URI . 'frontend/js/libs/bootstrap.custom.min.js',
			'ver' => $version,
		);
	...
	public static function load_asset_edit_form() {
		...
		$assets = array(
			...
			'ig-contactform-css',
			'ig-contactform-visualdesign-js',
		);
		$assets = apply_filters( 'ig_contactform_assets_form', $assets );
		$assets = array_merge(
			$assets, array(
				'ig-contactform-jquery-layout-js',
				'ig-contactform-itemlist-js',
				'ig-contactform-controls-js',
				'ig-contactform-js',
				'ig-contactform-form-js',
			)
		);
		return $assets;
	}
	...
	public static function get_translated( $strings ) {
		...
		foreach ( $strings AS $string ) {
			$translated[ strtoupper( $string ) ] = str_replace( "'", '&apos;', __( $string, IG_CONTACTFORM_TEXTDOMAIN ) );
		}
	...
	public static function get_list_page( $formContent, $formId = 0 ) {
			...
			foreach ( $formContent as $i => $fContent ) {
				...
				if ( $i == 0 ) {
					$defaultListpage .= '<div data-value="' . $fContent->page_id . '" id="form-design-header" class="jsn-section-header"><div class="jsn-iconbar-trigger page-title"><h1>' . $fContent->page_title . '</h1><div class="jsn-iconbar"><a href="javascript:void(0)" title="Edit page" class="element-edit"><i class="icon-pencil"></i></a><a href="javascript:void(0)" title="Delete page" class="element-delete"><i class="icon-trash"></i></a></div></div><div class="jsn-page-actions jsn-buttonbar"><div class="jsn-page-pagination pull-left btn-group"><button onclick="return false;" class="btn btn-icon prev-page"><i class="icon-arrow-left"></i></button><button onclick="return false;" class="btn btn-icon next-page"><i class="icon-arrow-right"></i></button></div><button onclick="return false;" class="btn btn-success new-page">' . __(
						'IG_CONTACTFORM_FORM_NEW_PAGE', IG_CONTACTFORM_TEXTDOMAIN
		...
		elseif ( $listPage ) {
			...
			if ( ! empty( $_GET[ 'form' ] ) ) {
				$getSampleForm = IGContactformHelper::get_sample_form( $_GET[ 'form' ] );
	...
	public static function get_form_content( $formId ) {
		...
		if ( ! empty( $formId ) && is_numeric( $formId ) ) {
			return $wpdb->get_results(
				$wpdb->prepare(
					"SELECT * FROM {$wpdb->prefix}ig_contactform_form_pages WHERE form_id = %d ORDER BY page_id ASC", $formId
				)
			);
		}
		return array();
	...
	public static function get_filed_by_form_id( $formId ) {
		...
		if ( ! empty( $formId ) && is_numeric( $formId ) ) {
			return $wpdb->get_results(
				$wpdb->prepare(
					"SELECT * FROM {$wpdb->prefix}ig_contactform_fields WHERE form_id = %d", $formId
				)
			);
		}
		return array();
	...
	public static function get_sample_form( $formType ) {
		...
		$createSampleForm = apply_filters( 'ig_contactform_create_form_sample', $createSampleForm );
	...
	static function get_public_taxonomies( $is_full = false ) {
		...
		foreach ( $taxs as $i => $tax ) {
			if ( isset( $tax->labels->singular_name ) && trim( $tax->labels->singular_name ) != '' ) {
				$arr_taxs[ $tax->name ] = __( $tax->labels->singular_name, IG_CONTACTFORM_TEXTDOMAIN );
			}
		}
		return $arr_taxs;
	}
	...
	static function get_post_types( $allow_filter = false ) {
		...
		foreach ( $posts as $i => $post ) {
			if ( ! $allow_filter ) {
				if ( $post->name == 'attachment' || $post->name == 'ig_cf_post_type' || $post->name == 'ig_cfsb_post_type' ) continue;
				if ( isset( $post->labels->singular_name ) && trim( $post->labels->singular_name ) != '' ) {
					$arr_posts[ $post->name ] = __( $post->labels->singular_name, IG_CONTACTFORM_TEXTDOMAIN );
				}
			}
			else {
				$arr_posts[ ] = $post->name;
		...
		$getAction = apply_filters( 'ig_contactform_get_action_data_submit_form', $arr_posts );
		if ( ! empty( $getAction ) ) {
			$arr_posts = $getAction;
		}
		return $arr_posts;
	...
	static function get_link_types() {
		...
		$action = array(
			'contactform_no_action' => __( 'IG_CONTACTFORM_NO_ACTION', IG_CONTACTFORM_TEXTDOMAIN ),
			'contactform_show_message' => __( 'IG_CONTACTFORM_SHOW_CUSTOM_MESSAGE', IG_CONTACTFORM_TEXTDOMAIN ),
			'contactform_url' => __( 'Go to URL', IG_CONTACTFORM_TEXTDOMAIN ),
			'single_entry' => array(
				'text' => __( 'Go to Single Entry', IG_CONTACTFORM_TEXTDOMAIN ),
				'type' => 'optiongroup',
				'options' => $post_types,
			),
			'taxonomy' => array(
				'text' => __( 'Go to Taxonomy Overview Page', IG_CONTACTFORM_TEXTDOMAIN ),
				'type' => 'optiongroup',
				'options' => $taxonomies,
			),
		);
		/* Add filter get add action submit form */
		$getAction = apply_filters( 'ig_contactform_get_action_submit_form', $action );
		if ( ! empty( $getAction ) ) {
			$action = $getAction;
		}
		return $action;
	...
	static function get_single_by_post_types( $posttype = '' ) {
		...
		foreach ( $posttypes as $slug => $name ) {
			...
			while ( $query->have_posts() ) {
				$query->the_post();
				$results[ $slug ][ get_the_ID() ] = __( get_the_title(), IG_CONTACTFORM_TEXTDOMAIN );
			}
			wp_reset_postdata();
		}
		...
		foreach ( $taxonomies as $taxo_slug => $taxo_name ) {
			...
			if ( $allow_root ) {
				...
				if ( in_array( $taxo_slug, $exclude_taxo ) ) {
					$term_taxos[ $taxo_slug ][ 'root' ] = __( 'Root', IG_CONTACTFORM_TEXTDOMAIN );
				}
			}
			$terms = get_terms(
				$taxo_slug, array(
			...
			if ( $order_by == 'name' ) {
				...
				foreach ( $arr_return as $i => $item ) {
					if ( $item->parent == 0 ) {
						unset( $arr_return[ $i ] );
						if ( ! $item->name ) {
							$item->name = __( '( no name )', IG_CONTACTFORM_TEXTDOMAIN );
						}
				...
				foreach ( $return as $id => $name ) {
					foreach ( $terms as $term ) {
						if ( $id == $term->term_id ) {
							$term_taxos[ $taxo_slug ][ $term->term_id ] = __( $name, IG_CONTACTFORM_TEXTDOMAIN );
						}
					}
				}
			}
				...
				foreach ( $terms as $term ) {
					$term_taxos[ $taxo_slug ][ $term->term_id ] = __( $term->name, IG_CONTACTFORM_TEXTDOMAIN );
				}
			}
		}
	...
	public static function generate_html_pages( $postId, $formId, $formName, $formType = '', $topContent = '', $bottomContent = '', $showTitle = false, $showDes = false ) {
		...
		//$assets[ ] = 'ig-contactform-jquery-ui-css';
		$loadBootstrap = get_option( 'ig_contactform_load_bootstrap_css', 1 );
		...
		$arrayTranslated = array(
			'IG_CONTACTFORM_CONFIRM_FIELD_PASSWORD_MIN_MAX_CHARACTER',
			'IG_CONTACTFORM_CONFIRM_FIELD_EMAIL_CONFIRM',
			'IG_CONTACTFORM_CONFIRM_FIELD_MIN_NUMBER',
			'IG_CONTACTFORM_CONFIRM_FIELD_MAX_NUMBER',
			...
			'IG_CONTACTFORM_CONFIRM_FIELD_MAX_LENGTH',
			'IG_CONTACTFORM_CONFIRM_FIELD_MIN_LENGTH',
			'IG_CONTACTFORM_CAPTCHA_PUBLICKEY',
			'IG_CONTACTFORM_BUTTON_BACK',
			'IG_CONTACTFORM_BUTTON_NEXT',
			'IG_CONTACTFORM_BUTTON_RESET',
			'IG_CONTACTFORM_BUTTON_SUBMIT',
			'IG_CONTACTFORM_CONFIRM_FIELD_CANNOT_EMPTY',
			'IG_CONTACTFORM_CONFIRM_FIELD_INVALID',
		);
		/* Check load JS */
		$checkLoadJS = array();
		...
		if ( $formPages ) {
			...
			if ( ! $formType ) {
				wp_enqueue_style( 'contactform_form_' . $formId, site_url() . '/?ig-gadget=contactform-style&action=default&form_id=' . $formId );
				$html .= "<div class=\"ig-contactform jsn-master\" data-form-name='" . $formName . "' id='ig_form_" . $formId . "'><div class=\"jsn-bootstrap\">";
				$html .= $topContent;
				$html .= "<form name='form_{$formName}' id='form_{$formName}' action=\"" . site_url() . '/?ig-gadget=contactform-frontend&action=default&task=form.save&form_id=' . $formId . "\" method=\"post\" class=\"form-validate {$classForm} \" enctype=\"multipart/form-data\" >";
				$html .= "<span class=\"hide ig-language\" style=\"display:none;\" data-value='" . json_encode( IGContactformHelper::get_translated( $arrayTranslated ) ) . "'></span>";
			...
			include_once ( IG_CONTACTFORM_PATH . 'helpers/form.php' );
			...
			foreach ( $formPages as $i => $contentForm ) {
				...
				if ( ! empty( $formContent ) ) {
					...
					$htmlForm .= IGContactformGenerateHtmlForm::generate( $formContent, $dataSumbission, $pageContainer );
				}
				...
				if ( $i + 1 == count( $formPages ) ) {
					if ( ! empty( $formSettings->form_captcha ) && $formSettings->form_captcha == 1 ) {
						...
						$html .= '<div id="' . md5( date( 'Y-m-d H:i:s' ) . $i . $formName ) . '"  publickey="' . IG_CONTACTFORM_CAPTCHA_PUBLICKEY . '" class="form-captcha control-group"></div>';
					}
					else if ( ! empty( $formSettings->form_captcha ) && $formSettings->form_captcha == 2 ) {
						include_once ( IG_CONTACTFORM_PATH . 'libraries/3rd-party/securimage/securimage.php' );
						$img = new Securimage();
						...
						ob_start();
						$img->show( IG_CONTACTFORM_PATH . 'libraries/3rd-party/securimage/backgrounds/bg4.png' );
						$dataCaptcha = base64_encode( ob_get_clean() );
						$html .= '<div class="control-group">
									<div class="controls">
									<div class="row-fluid"><img src="data:image/png;base64,' . $dataCaptcha . '" alt="CAPTCHA" /></div>
									<input type="text" id="ig-captcha" name="captcha" autocomplete="off" placeholder="' . __( 'Captcha', IG_CONTACTFORM_TEXTDOMAIN ) . '">
									</div>
									</div>';
					}
				}
			...
			if ( ! empty( $formSettings->form_state_btn_reset_text ) && $formSettings->form_state_btn_reset_text == 'Yes' ) {
				$htmlBtnReset = '<button class="' . $btnResetStyle . ' reset hide" onclick="return false;">' . __( $btnReset, IG_CONTACTFORM_TEXTDOMAIN ) . '</button>';
			}
			$html .= '<div class="form-actions">
									<div class="' . $btnPosition . '">
									    <button class="' . $btnPrevStyle . ' prev hide" onclick="return false;">' . __( $btnPrev, IG_CONTACTFORM_TEXTDOMAIN ) . '</button>
									    <button class="' . $btnNextStyle . ' next hide" onclick="return false;">' . __( $btnNext, IG_CONTACTFORM_TEXTDOMAIN ) . '</button>
									    <button type="submit" class="' . $btnSubmitStyle . ' jsn-form-submit hide" >' . __( $btnSubmit, IG_CONTACTFORM_TEXTDOMAIN ) . '</button>
									    ' . $htmlBtnReset . '
									</div>
								     </div>';
			...
			if ( $loadBootstrapJs != '0' && $loadBootstrapJs != 0 ) {
				$assets[ ] = 'ig-frontend-contactform-bootstrap-js';
			}
			$getFilterAssets = apply_filters( 'ig_contactform_filter_frontend_load_assets', $assets, $checkLoadJS );
			if ( ! empty( $getFilterAssets ) ) {
				$assets = $getFilterAssets;
			}

			$assets[ ] = 'ig-frontend-contactform-js';
		}
		$assets[ ] = 'ig-bootstrap2-icomoon-css';
		$assets[ ] = 'ig-bootstrap2-jsn-gui-css';
		$assets[ ] = 'ig-frontend-contactform-css';
	...
	public static function get_data_field( $fieldType, $submission, $key, $formId, $linkImg = false, $checkNull = true, $action = '' ) {
		...
		if ( $fieldType == 'checkboxes' || $fieldType == 'list' ) {
			...
			$getContentField = apply_filters( 'ig_contactform_get_content_field_' . str_replace( '-', '_', $fieldType ), $dataField, $fieldType, $submission, $key, $formId, $linkImg, $checkNull, $action );
	...
	public static function get_form_data( $formID, $submissionId ) {
		...
		if ( ! empty( $formID ) && is_numeric( $formID ) && ! empty( $submissionId ) && is_numeric( $submissionId ) ) {
			return $wpdb->get_results(
				$wpdb->prepare(
					"SELECT * FROM {$wpdb->prefix}ig_contactform_submission_data WHERE form_id = %d AND submission_id = %d", $formID, $submissionId
				)
			);
		}
	}
	...
	public static function get_footer( $return = false ) {
		add_filter( 'update_footer', array( __CLASS__, 'ig_contactform_update_footer' ) );
		$footer = '<div class="jsn-bootstrap ig-contactform-footer">
					<hr/>
					<div class="pull-left">
						<a href="http://wordpress.org/plugins/ig-contact-form/">IG ContactForm</a> by <a href="http://www.innogears.com/" target="_blank">InnoGears.com</a>
					</div>
					<div class="pull-right">
						<a href="http://www.innogears.com/docs/ig-contactform/" target="_blank">Documentation</a> |
						<a href="http://www.innogears.com/forum/ig-contactform.html" target="_blank">Support</a> |
						<a href="http://wordpress.org/support/view/plugin-reviews/ig-contact-form" target="_blank">Review</a>
					</div>
					<div class="clearbreak"></div>
			</div>';
		$getFooter = apply_filters( 'ig_contactform_footer', $footer );
		if ( ! empty( $getFooter ) ) {
			$footer = $getFooter;
		}
		if ( $return ) {
	 ...
	 * @return string
	 */
	public static function ig_contactform_update_footer( $footer ) {
		$footer = '';
		return $footer;
	}
	...
	public static function set_messages( $messages ) {
		...
		$messages[ 'ig_cf_post_type' ] = array(
