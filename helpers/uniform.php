...
class IGUniformHelper {
	...
	public static function apply_assets( $assets ) {
		...
		$assets[ 'ig-frontend-uniform-bootstrap-js' ] = array(
			'src' => IG_UNIFORM_URI . 'frontend/js/libs/bootstrap.custom.min.js',
			'ver' => $version,
		);
	...
	public static function get_footer( $return = false ) {
		...
		$footer = '<div class="jsn-bootstrap ig-contactform-footer">
					<hr/>
					<div class="pull-left">
						<a href="http://innogears.com/wordpress-plugins/ig-contactform-on-wporg.html">IG ContactForm</a> by <a href="http://innogears.com" target="_blank">InnoGears.com</a>
					</div>
					<div class="pull-right">
						<a href="http://innogears.com/wordpress-plugins/ig-contactform-docs.html" target="_blank">Documentation</a> |
						<a href="http://innogears.com/wordpress-plugins/ig-contactform-support.html" target="_blank">Support</a> |
						<a href="http://innogears.com/wordpress-plugins/ig-contactform-review.html" target="_blank">Review</a>
					</div>
