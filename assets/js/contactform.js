    ...
    JSNContactform.prototype = {
        ...
        createModalCustomizeEmail:function () {
            ...
            this.jsnContactformModal = new JSNModal({
                url:self.params.baseUrl + '?ig-gadget=contactform-email-settings&layout=config&tmpl=component&action=default&email=1&control=config',
                title:this.lang['IG_CONTACTFORM_EMAIL_ADDRESS_TITLE'],
                buttons:buttons,
                height:600,
                width:850,
                scrollable:true
        ...
        createModalEmailList:function () {
            ...
            this.jsnContactformModal = new JSNModal({
                url:self.params.baseUrl + '?ig-gadget=contactform-email-settings&email=1&action=default&control=form&form_id=' + $("#jform_form_id").val(),
                title:this.lang['IG_CONTACTFORM_EMAIL_ADDRESS_TITLE'],
                buttons:buttons,
                height:750,
                width:850,
        ...
        createModalEmailSubmit:function () {
            ...
            this.jsnContactformModal = new JSNModal({
                url:self.params.baseUrl + '?ig-gadget=contactform-email-settings&email=0&action=default&control=form&form_id=' + $("#jform_form_id").val(),
                title:this.lang['IG_CONTACTFORM_EMAIL_SUBMITTER_TITLE'],
                buttons:buttons,
                height:750,
                width:850,
                scrollable:true
                ...
                $('<div/>', {
                    ...
                    $("<div/>", {
                        ...
                        $("<button/>", {
                            ...
                            "title":self.lang['IG_CONTACTFORM_BUTTON_SAVE']
                        }).append(
                            $("<i/>", {
                                "class":"icon-ok"
                            }))).append(
                        $("<button/>", {
                            ...
                            "onclick":"return false;",
                            "title":self.lang['IG_CONTACTFORM_BUTTON_CANCEL']
                        }).append(
                            $("<i/>", {
                                "class":"icon-remove"
