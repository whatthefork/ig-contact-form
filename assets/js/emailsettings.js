    ...
    JSNContactformEmailSettingsView.prototype = {
        init:function () {
            ...
            if ($("#template_notify_to").val() == 1) {
                var emailContent = parent.jQuery("#ig-form-field-content_email_send_to").val();
            } else {
                var emailContent = parent.jQuery("#ig-form-field-content_email_send_to_submitter").val();
            }
            ...
            $.ajax({
                ...
                success:function (response) {
                    ...
                    $(".template-msg-content").css({"width":"81%"});
                    $("#ig_email_settings").removeClass("hide");
                    $("#form-loading").hide();
                }
            });
