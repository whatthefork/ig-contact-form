...
(function ($) {
    ...
    JSNUniform.prototype = {
        init:function () {
            ...
            var list_email_send_to = $("#ig-form-field-list_email_send_to").val();
        ...
        createModalCustomizeEmail:function () {
            ...
            this.jsnUniformModal = new JSNModal({
                url:self.params.baseUrl + '?ig-gadget=uniform-email-settings&layout=config&tmpl=component&action=default&email=1&control=config',
                title:this.lang['IG_UNIFORM_EMAIL_ADDRESS_TITLE'],
                buttons:buttons,
                height:600,
                width:850,
                scrollable:true
        ...
        createModalEmailList:function () {
            ...
            var buttons = {};
            buttons["Save"] = $.proxy(function () {
                var data = {}, attach = [], iframe = $(this.jsnUniformModal.iframe[0]).contents();
                ...
                data.attach = attach;
                $("#ig-form-field-content_email_send_to").val($.toJSON(data));
                $.closeModalBox();
            ...
            this.jsnUniformModal = new JSNModal({
                url:self.params.baseUrl + '?ig-gadget=uniform-email-settings&email=1&action=default&control=form&form_id=' + $("#jform_form_id").val(),
                title:this.lang['IG_UNIFORM_EMAIL_ADDRESS_TITLE'],
                buttons:buttons,
                height:750,
                width:850,
        ...
        createModalEmailSubmit:function () {
            ...
            buttons["Save"] = $.proxy(function () {
                ...
                data.attach = attach;
                $("#ig-form-field-content_email_send_to_submitter").val($.toJSON(data));
                $.closeModalBox();
                //this.jsnUniformModal.iframe[0].contentWindow.save();
            }, this);
            buttons["Cancel"] = $.proxy(function () {
            ...
            this.jsnUniformModal = new JSNModal({
                url:self.params.baseUrl + '?ig-gadget=uniform-email-settings&email=0&action=default&control=form&form_id=' + $("#jform_form_id").val(),
                title:this.lang['IG_UNIFORM_EMAIL_SUBMITTER_TITLE'],
                buttons:buttons,
                height:750,
                width:850,
                scrollable:true
                ...
                $('<div/>', {
                    ...
                    $("<div/>", {
                        ...
                        $("<button/>", {
                            ...
                            "title":self.lang['IG_UNIFORM_BUTTON_SAVE']
                        }).append(
                            $("<i/>", {
                                "class":"icon-ok"
                            }))).append(
                        $("<button/>", {
                            ...
                            "onclick":"return false;",
                            "title":self.lang['IG_UNIFORM_BUTTON_CANCEL']
                        }).append(
                            $("<i/>", {
                                "class":"icon-remove"
