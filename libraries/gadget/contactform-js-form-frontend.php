...
class IG_Gadget_Contactform_Js_Form_Frontend extends IG_Gadget_Base {
	...
	public function default_action() {
					                    ...
					                    iframe.load(function () {
					                        ...
					                        if (redirect) {
					                            ...
					                            $.ajax({
					                                ...
					                                url:baseUrl + "/?ig-gadget=contactform-frontend&action=default&task=form.getHtmlForm&form_id=" + $(selfsubmit).find("input[name=form_id]").val(),
		...
		$filterFunctionInit = apply_filters( 'ig_contactform_frontend_javascript_function_init', $filterFunctionInit );
		$functionForm = array();
		$functionForm[ 'initJSNForm' ] = '$.initJSNForm = function (formname) {
					            var self = this;
					            $(".form-captcha").hide();
					            if ($(\'.ig-contactform .icon-question-sign\').length) {
					                $(\'.ig-contactform .icon-question-sign\').tipsy({
					                    gravity:\'w\',
					                    fade:true
					                });
					            }
					                    ...
					                    $(this).keypress(function (e) {
					                            if (e.which != 27 && e.which != 13 && e.which != 8) {
					                                if (limitSettings.limitType == "Characters" && $(this).val().length == limitSettings.limitMax) {
					                                    alert(lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MAX_LENGTH\'] + " " + limitSettings.limitMax + " Characters");
					                                    return false;
					                                }
					                                if (limitSettings.limitType == "Words") {
					                                    ...
					                                    if (lengthValue.length == limitSettings.limitMax && e.which != 0) {
					                                        alert(lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MAX_LENGTH\'] + " " + limitSettings.limitMax + " Words");
					                                        return false;
					                                    }
					                                }
					                            }
		...
		$filterCheckFieldError = apply_filters( 'ig_contactform_frontend_javascript_check_field_error', $filterCheckFieldError );
		...
		$filterFunctionCheckPage = apply_filters( 'ig_contactform_frontend_javascript_function_check_page', $filterFunctionCheckPage );
					                    ...
					                    if (!checkBlank) {
					                        ...
					                        $(this).append(
					                            $("<span/>", {
					                                ...
					                                $("<span/>", {
					                                    "class":"validation-result label label-important",
					                                    text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_CANNOT_EMPTY\']
					                                })));
					                        check++;
					                    }
					                }
					                    ...
					                    if (!filter.test(val) && $(this).hasClass("email-required")) {
					                        ...
					                        $(this).parents(".controls").append(
					                            $("<span/>", {
					                                ...
					                                $("<span/>", {
					                                    "class":"validation-result label label-important",
					                                    text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_INVALID\']
					                                })));
					                        check++;
					                        ...
					                        if ($(parentEmail).find(".ig-email-confirm").val() != $(this).val()) {
					                            ...
					                            $(this).parents(".controls").append(
					                                $("<span/>", {
					                                    ...
					                                    $("<span/>", {
					                                        "class":"validation-result label label-important",
					                                        text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_EMAIL_CONFIRM\']
					                                    })));
					                            check++;
					                        }
					                    }
					                ...
					                $valueLimitPassword.each(function () {
					                    if ($(this).parents(".control-group").css("display") != "none") {
					                        ...
					                        if (!checkval) {
					                            ...
					                            if (checkPassword) {
					                                check++;
					                                var textLang = lang[\'IG_CONTACTFORM_CONFIRM_FIELD_PASSWORD_MIN_MAX_CHARACTER\'];
					                                ...
					                                if (lengthValue.length < limitSettings.limitMin) {
					                                    ...
					                                    $(this).after(
					                                        $("<span/>", {
					                                            ...
					                                            $("<span/>", {
					                                                "class":"validation-result label label-important",
					                                                text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MIN_LENGTH\'] + " " + limitSettings.limitMin + " Words"
					                                            })));
					                                    ...
					                                    $(this).after(
					                                        $("<span/>", {
					                                            ...
					                                            $("<span/>", {
					                                                "class":"validation-result label label-important",
					                                                text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MAX_LENGTH\'] + " " + limitSettings.limitMax + " Words"
					                                            })));
					                                }
					                            } else {
					                                if ($(this).val().length < limitSettings.limitMin) {
					                                    ...
					                                    $(this).after(
					                                        $("<span/>", {
					                                            ...
					                                            $("<span/>", {
					                                                "class":"validation-result label label-important",
					                                                text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MIN_LENGTH\'] + " " + limitSettings.limitMin + " Character"
					                                            })));
					                                } else if ($(this).val().length > limitSettings.limitMax) {
					                                    check++;
					                                    $(this).parent().parent().addClass("error");
					                                    $(this).after(
					                                        $("<span/>", {
					                                            ...
					                                            $("<span/>", {
					                                                "class":"validation-result label label-important",
					                                                text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MAX_LENGTH\'] + " " + limitSettings.limitMax + " Character"
					                                            })));
					                                }
					                            }
					                                ...
					                                if (parseInt($(this).val(), 10) < limitNumberSettings.limitMin) {
					                                    ...
					                                    $(this).parent().append(
					                                        $("<span/>", {
					                                            ...
					                                            $("<span/>", {
					                                                "class":"validation-result label label-important",
					                                                text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MIN_NUMBER\'] + " " + limitNumberSettings.limitMin
					                                            })));
					                                    ...
					                                    $(this).parent().append(
					                                        $("<span/>", {
					                                            ...
					                                            $("<span/>", {
					                                                "class":"validation-result label label-important",
					                                                text:lang[\'IG_CONTACTFORM_CONFIRM_FIELD_MAX_NUMBER\'] + " " + limitNumberSettings.limitMax
					                                            })));
					                                }
					                            }
		...
		$functionForm = apply_filters( 'ig_contactform_frontend_function_js_form', $functionForm );
		$javascript = '(function ($) {
					    $(function () {
