...
class IG_Gadget_Contactform_Js_Visualdesign_Itemlist extends IG_Gadget_Base {
	...
	public function default_action() {
		...
		$template = apply_filters( 'ig_contactform_filter_visualdesign_itemlist_template', $template );
		...
		$updateItems = apply_filters( 'ig_contactform_filter_visualdesign_itemlist_update_items', $updateItems );
		...
		$updateAction = apply_filters( 'ig_contactform_filter_visualdesign_itemlist_update_action', $updateAction );
		...
		$getBoxStyle = 'var display = element.css(\'display\')
            ...
            return style;';
		$getBoxStyle = apply_filters( 'ig_contactform_filter_visualdesign_itemlist_get_box_style', $getBoxStyle );
		...
		$openActionSettings = '$(".ig-lock-screen").remove();
            ...
            var container = $("#ig_contactform_master #form-container"), listOptionPage = [], instance = container.data(\'visualdesign-instance\'), content = "";
                        ...
                        success:function (response) {
                            ...
                            if ($(listFieldShow).html()) {
                                ...
                                $(".control-list-action #ig-action-show").append($("<ul/>", {"class":"jsn-items-list"}).append(
                                    $("<div/>", {"class":"ui-state-disabled"}).append(
                                        self.options.language.IG_CONTACTFORM_ALL_FORM_FIELD_ARE_DISPLAYED
                                    )
                                ));
                            }
                            if ($(listFieldHide).html()) {
                                ...
                                $(".control-list-action #ig-action-hide").append($("<ul/>", {"class":"jsn-items-list"}).append(
                                    $("<div/>", {"class":"ui-state-disabled"}).append(
                                        self.options.language.IG_CONTACTFORM_ALL_FORM_FIELD_ARE_HIDDEN
                                    )
                                ));
                            }
		...
		$openActionSettings = apply_filters( 'ig_contactform_filter_visualdesign_itemlist_action_settings', $openActionSettings );
		...
		$addEvents = apply_filters( 'ig_contactform_filter_visualdesign_itemlist_add_events', $addEvents );
		$render = 'var self = this;
		            ...
		            this.updateAction();
		            return this.control;';
		$render = apply_filters( 'ig_contactform_filter_visualdesign_itemlist_render', $render );
