		...
		<div class="jsn-page-upgrade">
			<div class="jsn-page-content jsn-rounded-large jsn-box-shadow-large jsn-bootstrap">
				...
				<div class="ig-product-about jsn-pane jsn-bgpattern pattern-sidebar">
					...
					<div class="ig-product-intro jsn-section-content">
						...
						<div class="ig-product-details">
							<dl>
								<dt>Author:</dt>
								<dd>
									<a href="http://www.innogears.com">Innogears.com</a>
								</dd>
								<dt>Copyright:</dt>
					...
					<div class="ig-product-cta jsn-bgpattern pattern-sidebar">
						<div class="pull-left">
							<ul class="jsn-list-horizontal">
								<li>
									<a href="http://www.innogears.com/free-joomla-templates-promo.html" class="btn" id="ig-about-promotion-modal"><i class="icon-briefcase"></i>&nbsp;See other products</a>
								</li>
							</ul>
						</div>
						<div class="pull-right">
							<ul class="jsn-list-horizontal">
								<li>
									<a target="_blank" title="Connect with us on Facebook" href="http://www.facebook.com/innogears" class="jsn-icon24 jsn-icon-social jsn-icon-facebook"></a>
								</li>
								<li>
									<a target="_blank" title="Follow us on Twitter" href="http://www.twitter.com/innogears" class="jsn-icon24 jsn-icon-social jsn-icon-twitter"></a>
								</li>
								<li>
									<a target="_blank" title="Watch us on YouTube" href="http://www.youtube.com/innogears" class="jsn-icon24 jsn-icon-social jsn-icon-youtube"></a>
								</li>
							</ul>
						</div>
						<div class="clearbreak"></div>
				...
				<div class="ig-product-support">
					<div>
						<h3 class="jsn-section-header">Help &amp; Support</h3>
						...
						<ul>
							...
							<li>
								<a class="jsn-link-action" target="_blank" href="http://www.innogears.com/dedicated-support.html">Submit ticket in Dedicated Support System</a> and get answer within 12 hours
								<strong>(*)</strong>.
							</li>
						</ul>
						<p><strong>(*)</strong> - Only available for <strong>PRO UNLIMITED</strong> edition owners.
						</p>
					</div>
					<div>
						<h3 class="jsn-section-header">Feedback</h3>

						<p>We would love to hear what you say:</p>
						<ul>
							<li>
								<a class="jsn-link-action" target="_blank" href="http://www.innogears.com/contact-us/product-feedback.html">Submit a bug report</a> and we will fix it ASAP.
							</li>
							<li>
								<a class="jsn-link-action" target="_blank" href="http://www.innogears.com/contact-us/product-feedback.html">Give a testimonial</a> to be placed in official
