<?php
require_once( IG_UNIFORM_PATH . '/helpers/form-edit.php' );
$getContainerFormEdit = new IGUniformEditForm();
$items = new stdClass;
$formContent = array();
...
$formContent = IGUniformHelper::get_form_content( $items->form_id );
$formPage = isset( $formContent[ 0 ]->page_content ) ? $formContent[ 0 ]->page_content : '';
$listPage = IGUniformHelper::get_list_page( $formContent, $items->form_id );
$form = array();
...
<div class="jsn-master" id="ig_uniform_master">
	<div class="jsn-bootstrap">
		...
		<div class="jsn-tabs">
			...
			<?php
			do_action( 'ig_uniform_form_container_tabs', $form, $formStyle, $formSettings, $listPage, $listFontType, $items, $formItems, $formPage );
			?>
		</div>
	</div>
</div>